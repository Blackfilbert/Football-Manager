...
import { SCOUT_TRAINING, SCOUT_CHANCES, RARITY_CONFIG } from '../../src/constants';
import { formatMoney, formatMoneyRaw, formatNumber, formatTime } from '../../src/utils';
...
export default function ScoutScreen() {
  ...
  const isMaxLevel = scoutLevel >= 15;
    ...
    <View style={s.container}>
      ...
      <ScrollView style={s.scroll} contentContainerStyle={s.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        {isMaxLevel ? (
          ...
          <Pressable
            style={[s.actionBtn, s.speedUpBtn, !canSpeedUp && s.disabledBtn]}
          ...
          <Pressable
            style={[s.actionBtn, s.upgradeBtn, !canAffordTraining && s.disabledBtn]}
